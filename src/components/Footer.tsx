        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="inline-block">
              <img alt="Pace" className="h-8 w-auto" src="/lovable-uploads/135a8db3-cda6-4570-a684-e9dbdb4e1fa4.png" />
            </Link>
            <p className="mt-4 text-muted-foreground max-w-md">
              Security-first workflow automation for growing businesses. 
              Eliminate operational friction and scale without the overhead.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.company.map(link => <li key={link.href}>
                  <Link to={link.href} className="text-muted-foreground hover:text-primary transition-colors duration-200">
                    {link.label}
                  </Link>
                </li>)}
            </ul>
