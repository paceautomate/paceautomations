        ...
        <section className="py-16">
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="p-8 rounded-2xl border border-border bg-gradient-card animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                <div className="text-6xl font-bold text-gradient-blue mb-4">10-250</div>
                <div className="text-xl font-semibold mb-2">Employee Sweet Spot</div>
